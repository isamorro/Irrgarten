    ...
    */
    ...
    private void manageResurrection(){
        ...
        if (resurrect){
            ...
            // Modifica el currentPlayer al nuevo FuzzyPlayer
            currentPlayer = fp;
            // Modifica el array de players 
            players.set(currentPlayerIndex, fp);
            // Modifica en el laberinto al jugador por el FuzzyPlayer
            labyrinth.resurrectionFuzzyPlayer(currentPlayer.getRow(),
                                              currentPlayer.getCol(), fp);
            logResurrected();
        }
        else {
            logPlayerSkipTurn();
