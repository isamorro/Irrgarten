...
public class Dice {
    ...
    private final float MAX_INTELLIGENCE;
    private final float MAX_STRENGTH;
    private final float RESURRECT_PROB;
    private final int WEAPONS_REWARD;
    private final int SHIELDS_REWARD;
    private final int HEALTH_REWARD;
     ...
     * @return  Valor aleatorio entre 0 y comepetence - 1
     */
